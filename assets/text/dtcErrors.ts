...
export const dtcErrors: DtcErrorsInterface = {
    en: {
        ...
        reverseGeocodeFailed: 'Could not determine the place name for this location. Enter it manually.',
    ...
    pl: {
        ...
        friendAlreadyExists: 'Zaproszenie lub znajomość z tym użytkownikiem już istnieje.',
        friendNotFound: 'To zaproszenie już nie istnieje.',
        friendEmailInvalid: 'Podaj poprawny adres e-mail.',
        reverseGeocodeFailed: 'Nie udało się ustalić nazwy miejsca dla tej lokalizacji. Wpisz ją ręcznie.',
