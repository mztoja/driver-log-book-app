interface Entries {
    ...
    generatorEmptyLeg: string;
    generatorShareError: string;
    generatorSkippedLegs(x: string): string;
    generateAndOpen: string;
    generatorOpenAgain: string;
    generatorShare: string;
    generatorNoPdfApp: string;
    generatorEditHint: string;
    ...
    genDistance: string;
    genRef(x: string): string;
    genFuelBefore: string;
    genFuelAfter: string;
    genFuelConsumption: string;
    genRefueled: string;
    genFuelDate(x: string): string;
    genFuelCity(x: string): string;
    genFuelOdometer(x: string): string;
    genFuelValue(x: string): string;
    genExpense(x: string): string;
    genStops: string;
    genOther: string;
    genLeg(x: string): string;
    genAddLeg: string;
    legStartCity: string;
    legStartData: string;
